...
if __name__ == '__main__':
    files = ['candump-2020-02-01_002021.log.cleaned',
             'candump-2020-02-01_064221.log.cleaned',
             'candump-2020-02-01_064222.log.cleaned',
             'candump-2020-02-01_064223.log.cleaned']
    path = '../datalog'
    for file in files:
        filename = path + '/' + file
